...
@AlternativeStopPositions
def customOffset_Spot82(aircraftData):
    if aircraftData.aircraftGroup in {"ARC-A", "ARC-B", "ARC-C"}: 
        return Distance.fromMeters(-9.34), Distance.fromMeters(-5.06)
    else:
        return customOffset_Spot81(aircraftData)
...
def customOffset_Spot406(aircraftData):
    ...
    if aircraftData.idMajor == 737:
        return Distance.fromMeters(-13.32), Distance.fromMeters(9.50)
...
@AlternativeStopPositions
def customOffset_Spot509(aircraftData):
    if aircraftData.aircraftGroup in {"ARC-A", "ARC-B", "ARC-C"}: 
        return Distance.fromMeters(-8.42), Distance.fromMeters(-3.03)
    else:
        return customOffset_Spot507(aircraftData)
...
parkings = {
    GATE :{
        ...
        # Terminal 2
        53 : (CustomizedName("Gates-T2 (47-65) Domestic|SPOT #§ [ANA]"), customOffset_Spot53),
        54 : (CustomizedName("Gates-T2 (47-65) Domestic|SPOT #§ [SNA/ADO/ANA]"), customOffset_Spot54),
        55 : (CustomizedName("Gates-T2 (47-65) Domestic|SPOT #§ [ADO/SNA/ANA]"), customOffset_Spot55),
        56 : (CustomizedName("Gates-T2 (47-65) Domestic|SPOT #§ [ADO/SNA/ANA]"), customOffset_Spot56),
        57 : (CustomizedName("Gates-T2 (47-65) Domestic|SPOT #§ [ANA]"), customOffset_Spot53),
        58 : (CustomizedName("Gates-T2 (47-65) Domestic|SPOT #§ [ANA]"), customOffset_Spot58),
        59 : (CustomizedName("Gates-T2 (47-65) Domestic|SPOT #§ [ANA]"), customOffset_Spot65),
        60 : (CustomizedName("Gates-T2 (47-65) Domestic|SPOT #§ [ANA]"), customOffset_Spot65),
        61 : (CustomizedName("Gates-T2 (47-65) Domestic|SPOT #§ [ANA]"), customOffset_Spot65),
        62 : (CustomizedName("Gates-T2 (47-65) Domestic|SPOT #§ [ANA]"), customOffset_Spot65),
        63 : (CustomizedName("Gates-T2 (47-65) Domestic|SPOT #§ [ANA]"), customOffset_Spot65),
        64 : (CustomizedName("Gates-T2 (47-65) Domestic|SPOT #§ [ANA]"), customOffset_Spot65),
        65 : (CustomizedName("Gates-T2 (47-65) Domestic|SPOT #§ [ANA]"), customOffset_Spot65),
        ...
        # Terminal 3
        105 : (CustomizedName("Gates-T3 International|SPOT #§(P) [INTL]"), customOffset_Spot105),
        ...
        406 : (CustomizedName("Gates-T2 (47-65) Domestic|SPOT 47 (406) [ANA]"), customOffset_Spot406),
        407 : (CustomizedName("Gates-T2 (47-65) Domestic|SPOT 48 (407) [ANA]"), customOffset_Spot406),
        408 : (CustomizedName("Gates-T2 (47-65) Domestic|SPOT 49 (408) [ANA]"), customOffset_noOffset),
    ...
    PARKING :{
        ...
        40 : (CustomizedName("Open Spots 31-41|SPOT #§ [JAL/SJO (Yamato)]"), customOffset_Spot38),
        41 : (CustomizedName("Open Spots 31-41|SPOT #§ [JAL/SKY/SJO (Yamato)]"), customOffset_Spot38),

        # Terminal 2/East Side Okidome
        81 : (CustomizedName("Open Spots 81-84|SPOT #§ [ANA]"), customOffset_Spot81),
        82 : (CustomizedName("Open Spots 81-84|SPOT #§ [ANA]"), customOffset_Spot82),
        ...
        401 : (CustomizedName("Open Spots 400s|SPOT #§ [ALL]"), customOffset_noOffset),
        402 : (CustomizedName("Open Spots 400s|[CLSD] SPOT #§ [ALL]"), customOffset_Spot402),
        ...
        509 : (CustomizedName("Open Spots 500s|SPOT #§ [ANA/SNA/ADO]"), customOffset_Spot509),
